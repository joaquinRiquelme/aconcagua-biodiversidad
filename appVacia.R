...
sidebar_acc <- accordion(
  ...
  accordion_panel(
    ...
    checkboxGroupInput(
      "origin", NULL,
      choices = c("opcion1","opcion2","opcion3"),#sort(unique(flights$origin)),
      inline = TRUE
    )
  ),
  accordion_panel(
    ...
    selectInput(
      "dest_name", NULL,
      c("opcion1","opcion2","opcion3"),#sort(unique(flights$dest_name)),
      multiple = TRUE,
      width = "100%"
    )
  ),
  accordion_panel(
    ...
    selectInput(
      "carrier_name", NULL,
      c("opcion1","opcion2","opcion3"),#unique(flights$carrier_name),
      multiple = TRUE,
      width = "100%"
    )
  ),
  accordion_panel(
    ...
    input_histoslider(
      "date", "Date",
      trees$Volume, height = 125, breaks = "months",
      options = list(
